<div>
    <div x-data="{ isMenuOpen: false }" class="relative khmer">
        <div
            class="px-6 py-2 bg-gradient-to-r from-beige-400 via-beige-600 to-beige-800 text-white hidden md:flex items-center justify-center space-x-4 khmer">
